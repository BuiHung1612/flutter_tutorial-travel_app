...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: BlocBuilder<AppCubits, CubitsState>(
                ...
                Positioned(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: NetworkImage(
                              'http://mark.bslmeiyu.com/uploads/${state.place.img}'),
                          fit: BoxFit.cover)),
                )),
                Positioned(
                    left: 20,
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                AppText(text: state.place.location)
                              ],
                            ),
                            const SizedBox(
                              height: 10,
                            ...
                            Row(
                              children: [
                                ...
                                AppText(
                                  text: "(${state.place.stars.toString()})",
